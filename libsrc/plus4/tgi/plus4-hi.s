;
; Graphics driver for the 320x200x2 mode on the PLUS4.
;
; Based on Stephen L. Judd's GRLIB code.
;
; 2018-08-07, Thomas Cherryhomes
...
; INIT/DONE
OLDFF12:        .res    1       ; Old register value
...
CBASE           := $0C00                ; Color memory base address
...
; Switch into graphics mode
        ...
        lda     $FF12
        sta     OLDFF12
        lda     #$30            ; Set color map to $D000, screen to $E000
        sta     $FF12

        lda     $FF06           ; And turn on bitmap
        ora     #$20
DONE1:  sta     $FF06
